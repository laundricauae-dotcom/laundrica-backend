...
const langcachedefaulterror_js_1 = require("../models/errors/langcachedefaulterror.js");
...
function match(...matchers) {
    return async function matchFunc(response, request, options) {
        ...
        if (!matcher) {
            return [{
                    ok: false,
                    error: new langcachedefaulterror_js_1.LangCacheDefaultError("Unexpected Status or Content-Type", {
                        response,
                        request,
        ...
        if (matcher.enc === "fail") {
            return [{
                    ok: false,
                    error: new langcachedefaulterror_js_1.LangCacheDefaultError("API error occurred", {
                        request,
                        response,
                        body,
                    }),
